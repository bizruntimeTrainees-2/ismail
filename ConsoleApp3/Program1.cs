    ...
    class Program1
    {
        static void Main(string[] args)
        {
            ...
            using (SqlConnection con = new SqlConnection(conString))
            {
             ...
             static DataTable CreateOrderTable()
            {
             ...
             static DataTable CreateOrderDetailTable()
            {
             ...
             static void InsertOrders(DataTable orderTable)
            {
                // Add one row once.
             ...
             static void InsertOrderDetails(DataTable orderDetailTable)
            {
            ...
            Console.WriteLine("query exicuted successfully");
        }
    }
}
